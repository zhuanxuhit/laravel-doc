...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
    ...
    {
        //!! 调用的是Illuminate\Container\Container中的静态方法,注册为一个全局的变量,注意static的使用,延迟绑定
    ...
    {
        //!! 注册了两个Service Provider
        //!! 在register方法中,会调用ServiceProvider的register方法
        //!! 在EventServiceProvider的register方法调用$this->singleton方法设置events
    ...
    {
        //!! 此处events是在EventServiceProvider->register中注册的
        //!! 此处通过数组的方式访问,是因为实现了ArrayAccess接口,访问容器的offsetGet函数
        //!! 通过调用container->make,实例化出events
    ...
    {
        //!! Illuminate\Contracts\Http\Kernel为例子
        $abstract = $this->getAlias($abstract);
//        if($abstract=='app')dd($this);
        //!! 此时根据app,会从instance中获取到
